...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_ME,+1,-1*IC(1),W(1,1))  !  count 3
      CALL OXXXXX(P(0,1),MDL_ME,-1,-1*IC(1),W(1,2))  !  count 3
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3))  !  count 14
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4))  !  count 11
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,5))  !  count 44
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,6))  !  count 5
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,7))  !  count 5
      CALL IXXXXX(P(0,5),MDL_ME,+1,-1*IC(5),W(1,8))  !  count 4
      CALL IXXXXX(P(0,5),MDL_ME,-1,-1*IC(5),W(1,9))  !  count 4
      CALL OXXXXX(P(0,6),ZERO,+1,+1*IC(6),W(1,10))  !  count 8
      ...
      CALL FFS3C1_1(W(1,10),W(1,11),GC_52,MDL_MN1,FK_MDL_WN1,W(1,15))  !  count 3
      CALL FFS3C1_1(W(1,10),W(1,12),GC_52,MDL_MN1,FK_MDL_WN1,W(1,16))  !  count 6
      CALL FFS3C1_1(W(1,10),W(1,13),GC_52,MDL_MN1,FK_MDL_WN1,W(1,17))  !  count 6
      CALL FFS3C1_1(W(1,10),W(1,14),GC_52,MDL_MN1,FK_MDL_WN1,W(1,18))  !  count 6
      CALL FFS1_3(W(1,3),W(1,2),GC_149,MDL_MH,FK_MDL_WH,W(1,19))  !  count 12
      CALL FFS1_3(W(1,4),W(1,1),GC_149,MDL_MH,FK_MDL_WH,W(1,20))  !  count 9
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))
      CALL FFS3P1N_2(W(1,5), W(1,20), GC_52, TMP(1))
      call CombineAmp(3,
     & (/5,7,6/), 
     & (/16,17,18/),
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5C1_1(W(1,10),W(1,21),GC_50,MDL_MN1,FK_MDL_WN1,W(1,25))  !  count 3
      CALL FFV5C1_1(W(1,10),W(1,22),GC_50,MDL_MN1,FK_MDL_WN1,W(1,26))  !  count 6
      CALL FFV5C1_1(W(1,10),W(1,23),GC_50,MDL_MN1,FK_MDL_WN1,W(1,27))  !  count 6
      CALL FFV5C1_1(W(1,10),W(1,24),GC_50,MDL_MN1,FK_MDL_WN1,W(1,28))  !  count 6
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/25,26,27,28/),
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL IXXXXX(P(0,6),ZERO,+1,-1*IC(6),W(1,29))  !  count 2
      CALL FFV5_3(W(1,29),W(1,6),GC_22,MDL_MW,FK_MDL_WW,W(1,30))  !  count 2
      CALL FFV5_3(W(1,29),W(1,7),GC_22,MDL_MW,FK_MDL_WW,W(1,31))  !  count 2
      CALL OXXXXX(P(0,5),MDL_ME,+1,+1*IC(5),W(1,32))  !  count 2
      CALL OXXXXX(P(0,5),MDL_ME,-1,+1*IC(5),W(1,33))  !  count 2
      CALL FFV5C1_1(W(1,32),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,34))  !  count 3
      CALL FFV5C1_1(W(1,32),W(1,31),GC_49,MDL_MN1,FK_MDL_WN1,W(1,35))  !  count 6
      CALL FFV5C1_1(W(1,33),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,36))  !  count 6
      CALL FFV5C1_1(W(1,33),W(1,31),GC_49,MDL_MN1,FK_MDL_WN1,W(1,37))  !  count 6
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/34,35,36,37/),
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      CALL FFV5_6_3(W(1,4),W(1,1),GC_44,GC_40,MDL_MZ,FK_MDL_WZ,W(1,39))  !  count 9
      CALL FFV5P1N_2(W(1,5), W(1,38), GC_50, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,4))
      CALL FFV5P1N_2(W(1,5), W(1,39), GC_50, TMP(1))
      call CombineAmp(3,
     & (/5,7,6/), 
     & (/16,17,18/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV5_3(W(1,5),W(1,1),GC_22,MDL_MW,ZERO,W(1,40))  !  count 9
      CALL FFV5_3(W(1,5),W(1,2),GC_22,MDL_MW,ZERO,W(1,41))  !  count 12
      CALL FFV5P1N_2(W(1,3), W(1,41), GC_49, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,7))
      CALL FFV5P1N_2(W(1,4), W(1,40), GC_49, TMP(1))
      call CombineAmp(3,
     & (/5,7,6/), 
     & (/16,17,18/),
...
C       JAMPs contributing to orders ALL_ORDERS=1
        JAMP(1,1) = AMP( K,1)+AMP( K,2)+(-1.000000000000000D+00)*AMP( K,
     $  3)+AMP( K,4) +AMP( K,5)+(-1.000000000000000D+00)*AMP( K,6)+(-1.000000000
     $  000000D+00) *AMP( K,7)+(-1.000000000000000D+00)*AMP( K,8)+AMP( K,9)
