...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL OXXXXX(P(0,1),MDL_ME,-1,-1*IC(1),W(1,2))  !  count 11
      ...
      CALL FFS3_2(W(1,10),W(1,14),GC_52,MDL_MN1,FK_MDL_WN1,W(1,18))  !  count 3
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5_2(W(1,10),W(1,24),GC_50,MDL_MN1,FK_MDL_WN1,W(1,28))  !  count 3
      CALL FFS4P1N_1(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/25,26,27/),
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV5_2(W(1,9),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,34))  !  count 3
      CALL FFS4P1N_1(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/31,32,33/),
     ...
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV5_3(W(1,25),W(1,1),GC_49,MDL_MW,ZERO,W(1,44))  !  count 1
      CALL FFV5_3(W(1,25),W(1,2),GC_49,MDL_MW,ZERO,W(1,45))  !  count 1
      CALL FFV5_3(W(1,26),W(1,1),GC_49,MDL_MW,ZERO,W(1,46))  !  count 1
      CALL FFV5_3(W(1,26),W(1,2),GC_49,MDL_MW,ZERO,W(1,47))  !  count 1
      CALL FFV5_3(W(1,27),W(1,1),GC_49,MDL_MW,ZERO,W(1,48))  !  count 1
      CALL FFV5_3(W(1,27),W(1,2),GC_49,MDL_MW,ZERO,W(1,49))  !  count 1
      CALL FFV5_3(W(1,28),W(1,1),GC_49,MDL_MW,ZERO,W(1,50))  !  count 1
      CALL FFV5P1N_3(W(1,3), W(1,5), GC_22, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/45,47,49/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV5_3(W(1,31),W(1,1),GC_49,MDL_MW,ZERO,W(1,51))  !  count 1
      CALL FFV5_3(W(1,31),W(1,2),GC_49,MDL_MW,ZERO,W(1,52))  !  count 1
      CALL FFV5_3(W(1,32),W(1,1),GC_49,MDL_MW,ZERO,W(1,53))  !  count 1
      CALL FFV5_3(W(1,32),W(1,2),GC_49,MDL_MW,ZERO,W(1,54))  !  count 1
      CALL FFV5_3(W(1,33),W(1,1),GC_49,MDL_MW,ZERO,W(1,55))  !  count 1
      CALL FFV5_3(W(1,33),W(1,2),GC_49,MDL_MW,ZERO,W(1,56))  !  count 1
      CALL FFV5_3(W(1,34),W(1,1),GC_49,MDL_MW,ZERO,W(1,57))  !  count 1
      CALL FFV5P1N_3(W(1,3), W(1,5), GC_22, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/52,54,56/),
