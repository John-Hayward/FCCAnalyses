...
C     
      ...
      PARAMETER (NWAVEFUNCS=63, NCOLOR=1) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,6))  !  count 4
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,7))  !  count 4
      CALL IXXXXX(P(0,5),MDL_ME,+1,-1*IC(5),W(1,8))  !  count 5
      CALL IXXXXX(P(0,5),MDL_ME,-1,-1*IC(5),W(1,9))  !  count 5
      ...
      CALL FFS4C1_2(W(1,10),W(1,11),GC_52,MDL_MN1,FK_MDL_WN1,W(1,15))  !  count 6
      CALL FFS4C1_2(W(1,10),W(1,12),GC_52,MDL_MN1,FK_MDL_WN1,W(1,16))  !  count 6
      CALL FFS4C1_2(W(1,10),W(1,13),GC_52,MDL_MN1,FK_MDL_WN1,W(1,17))  !  count 6
      CALL FFS4C1_2(W(1,10),W(1,14),GC_52,MDL_MN1,FK_MDL_WN1,W(1,18))  !  count 6
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5C1_2(W(1,10),W(1,21),GC_50,MDL_MN1,FK_MDL_WN1,W(1,25))  !  count 6
      CALL FFV5C1_2(W(1,10),W(1,22),GC_50,MDL_MN1,FK_MDL_WN1,W(1,26))  !  count 6
      CALL FFV5C1_2(W(1,10),W(1,23),GC_50,MDL_MN1,FK_MDL_WN1,W(1,27))  !  count 6
      CALL FFV5C1_2(W(1,10),W(1,24),GC_50,MDL_MN1,FK_MDL_WN1,W(1,28))  !  count 6
      CALL FFS4P1N_1(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/25,26,27,28/),
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,29))  !  count 2
      CALL FFV5_3(W(1,8),W(1,29),GC_22,MDL_MW,FK_MDL_WW,W(1,30))  !  count 2
      CALL FFV5_3(W(1,9),W(1,29),GC_22,MDL_MW,FK_MDL_WW,W(1,31))  !  count 2
      CALL IXXXXX(P(0,4),MDL_ME,+1,-1*IC(4),W(1,32))  !  count 2
      CALL IXXXXX(P(0,4),MDL_ME,-1,-1*IC(4),W(1,33))  !  count 2
      CALL FFV5C1_2(W(1,32),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,34))  !  count 6
      CALL FFV5C1_2(W(1,32),W(1,31),GC_49,MDL_MN1,FK_MDL_WN1,W(1,35))  !  count 6
      CALL FFV5C1_2(W(1,33),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,36))  !  count 6
      CALL FFV5C1_2(W(1,33),W(1,31),GC_49,MDL_MN1,FK_MDL_WN1,W(1,37))  !  count 6
      CALL FFS4P1N_1(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,4,1,2/), 
     & (/34,35,36,37/),
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV5_6_3(W(1,3),W(1,2),GC_44,GC_40,MDL_MZ,FK_MDL_WZ,W(1,38))  !  count 12
      CALL FFV5_6_3(W(1,4),W(1,1),GC_44,GC_40,MDL_MZ,FK_MDL_WZ,W(1,39))  !  count 12
      CALL FFV5P1N_1(W(1,5), W(1,38), GC_50, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,4))
      CALL FFV5P1N_1(W(1,5), W(1,39), GC_50, TMP(1))
      call CombineAmp(4,
     & (/7,5,8,6/), 
     & (/15,16,17,18/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV5_3(W(1,15),W(1,1),GC_49,MDL_MW,ZERO,W(1,40))  !  count 1
      CALL FFV5_3(W(1,15),W(1,2),GC_49,MDL_MW,ZERO,W(1,41))  !  count 1
      CALL FFV5_3(W(1,16),W(1,1),GC_49,MDL_MW,ZERO,W(1,42))  !  count 1
      CALL FFV5_3(W(1,16),W(1,2),GC_49,MDL_MW,ZERO,W(1,43))  !  count 1
      CALL FFV5_3(W(1,17),W(1,1),GC_49,MDL_MW,ZERO,W(1,44))  !  count 1
      CALL FFV5_3(W(1,17),W(1,2),GC_49,MDL_MW,ZERO,W(1,45))  !  count 1
      CALL FFV5_3(W(1,18),W(1,1),GC_49,MDL_MW,ZERO,W(1,46))  !  count 1
      CALL FFV5_3(W(1,18),W(1,2),GC_49,MDL_MW,ZERO,W(1,47))  !  count 1
     ...
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV5_3(W(1,25),W(1,1),GC_49,MDL_MW,ZERO,W(1,48))  !  count 1
      CALL FFV5_3(W(1,25),W(1,2),GC_49,MDL_MW,ZERO,W(1,49))  !  count 1
      CALL FFV5_3(W(1,26),W(1,1),GC_49,MDL_MW,ZERO,W(1,50))  !  count 1
      CALL FFV5_3(W(1,26),W(1,2),GC_49,MDL_MW,ZERO,W(1,51))  !  count 1
      CALL FFV5_3(W(1,27),W(1,1),GC_49,MDL_MW,ZERO,W(1,52))  !  count 1
      CALL FFV5_3(W(1,27),W(1,2),GC_49,MDL_MW,ZERO,W(1,53))  !  count 1
      CALL FFV5_3(W(1,28),W(1,1),GC_49,MDL_MW,ZERO,W(1,54))  !  count 1
      CALL FFV5_3(W(1,28),W(1,2),GC_49,MDL_MW,ZERO,W(1,55))  !  count 1
      CALL FFV5P1N_3(W(1,3), W(1,5), GC_22, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/49,51,53,55/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV5_3(W(1,34),W(1,1),GC_49,MDL_MW,ZERO,W(1,56))  !  count 1
      CALL FFV5_3(W(1,34),W(1,2),GC_49,MDL_MW,ZERO,W(1,57))  !  count 1
      CALL FFV5_3(W(1,35),W(1,1),GC_49,MDL_MW,ZERO,W(1,58))  !  count 1
      CALL FFV5_3(W(1,35),W(1,2),GC_49,MDL_MW,ZERO,W(1,59))  !  count 1
      CALL FFV5_3(W(1,36),W(1,1),GC_49,MDL_MW,ZERO,W(1,60))  !  count 1
      CALL FFV5_3(W(1,36),W(1,2),GC_49,MDL_MW,ZERO,W(1,61))  !  count 1
      CALL FFV5_3(W(1,37),W(1,1),GC_49,MDL_MW,ZERO,W(1,62))  !  count 1
      CALL FFV5_3(W(1,37),W(1,2),GC_49,MDL_MW,ZERO,W(1,63))  !  count 1
      CALL FFV5P1N_3(W(1,3), W(1,5), GC_22, TMP(1))
      call CombineAmp(4,
     & (/3,4,1,2/), 
     & (/57,59,61,63/),
