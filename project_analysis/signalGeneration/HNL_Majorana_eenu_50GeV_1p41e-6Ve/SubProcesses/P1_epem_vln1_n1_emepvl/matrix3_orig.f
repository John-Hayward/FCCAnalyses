...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV5_3(W(1,3),W(1,1),GC_22,MDL_MW, ZERO,W(1,7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = AMP(1)+AMP(2)+(-1.000000000000000D+00)*AMP(3)+AMP(4)
     $ +AMP(5)+(-1.000000000000000D+00)*AMP(6)+(-1.000000000000000D+00)
     $ *AMP(7)+(-1.000000000000000D+00)*AMP(8)+AMP(9)
