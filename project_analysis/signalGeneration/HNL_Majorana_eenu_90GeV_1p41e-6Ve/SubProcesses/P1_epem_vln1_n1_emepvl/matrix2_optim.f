...
C     
      ...
      PARAMETER (NWAVEFUNCS=57, NCOLOR=1) 
      REAL*8     ZERO
      PARAMETER (ZERO=0D0)
      COMPLEX*16 IMAG1
...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL OXXXXX(P(0,1),MDL_ME,+1,-1*IC(1),W(1,1))  !  count 11
      ...
      CALL OXXXXX(P(0,3),ZERO,-1,+1*IC(3),W(1,5))  !  count 63
      ...
      CALL FFS3_2(W(1,10),W(1,11),GC_52,MDL_MN1,FK_MDL_WN1,W(1,15))  !  count 3
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5_2(W(1,10),W(1,21),GC_50,MDL_MN1,FK_MDL_WN1,W(1,25))  !  count 3
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV5_2(W(1,8),W(1,29),GC_49,MDL_MN1,FK_MDL_WN1,W(1,31))  !  count 3
     ...
     & TMP, W, AMP(1,3))  !  count 1
      ...
      CALL FFV5_6_3(W(1,4),W(1,1),GC_44,GC_40,MDL_MZ,FK_MDL_WZ,W(1,36))  !  count 9
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV5_3(W(1,15),W(1,2),GC_49,MDL_MW,ZERO,W(1,37))  !  count 1
      CALL FFV5_3(W(1,16),W(1,1),GC_49,MDL_MW,ZERO,W(1,38))  !  count 1
      CALL FFV5_3(W(1,16),W(1,2),GC_49,MDL_MW,ZERO,W(1,39))  !  count 1
      CALL FFV5_3(W(1,17),W(1,1),GC_49,MDL_MW,ZERO,W(1,40))  !  count 1
      CALL FFV5_3(W(1,17),W(1,2),GC_49,MDL_MW,ZERO,W(1,41))  !  count 1
      CALL FFV5_3(W(1,18),W(1,1),GC_49,MDL_MW,ZERO,W(1,42))  !  count 1
      CALL FFV5_3(W(1,18),W(1,2),GC_49,MDL_MW,ZERO,W(1,43))  !  count 1
     ...
     & TMP, W, AMP(1,7))  !  count 1
      CALL FFV5_3(W(1,25),W(1,2),GC_49,MDL_MW,ZERO,W(1,44))  !  count 1
      CALL FFV5_3(W(1,26),W(1,1),GC_49,MDL_MW,ZERO,W(1,45))  !  count 1
      CALL FFV5_3(W(1,26),W(1,2),GC_49,MDL_MW,ZERO,W(1,46))  !  count 1
      CALL FFV5_3(W(1,27),W(1,1),GC_49,MDL_MW,ZERO,W(1,47))  !  count 1
      CALL FFV5_3(W(1,27),W(1,2),GC_49,MDL_MW,ZERO,W(1,48))  !  count 1
      CALL FFV5_3(W(1,28),W(1,1),GC_49,MDL_MW,ZERO,W(1,49))  !  count 1
      CALL FFV5_3(W(1,28),W(1,2),GC_49,MDL_MW,ZERO,W(1,50))  !  count 1
      CALL FFV5P1N_3(W(1,3), W(1,5), GC_22, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/44,46,48,50/),
     ...
     & TMP, W, AMP(1,8))  !  count 1
      CALL FFV5_3(W(1,31),W(1,2),GC_49,MDL_MW,ZERO,W(1,51))  !  count 1
      CALL FFV5_3(W(1,32),W(1,1),GC_49,MDL_MW,ZERO,W(1,52))  !  count 1
      CALL FFV5_3(W(1,32),W(1,2),GC_49,MDL_MW,ZERO,W(1,53))  !  count 1
      CALL FFV5_3(W(1,33),W(1,1),GC_49,MDL_MW,ZERO,W(1,54))  !  count 1
      CALL FFV5_3(W(1,33),W(1,2),GC_49,MDL_MW,ZERO,W(1,55))  !  count 1
