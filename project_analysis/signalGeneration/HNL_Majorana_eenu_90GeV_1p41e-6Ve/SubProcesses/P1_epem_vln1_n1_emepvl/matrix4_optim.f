...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,5))  !  count 50
      ...
      CALL FFS3C1_1(W(1,10),W(1,11),GC_52,MDL_MN1,FK_MDL_WN1,W(1,15))  !  count 6
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5C1_1(W(1,10),W(1,21),GC_50,MDL_MN1,FK_MDL_WN1,W(1,25))  !  count 6
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV5C1_1(W(1,32),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,34))  !  count 6
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV5_3(W(1,5),W(1,1),GC_22,MDL_MW,ZERO,W(1,40))  !  count 12
