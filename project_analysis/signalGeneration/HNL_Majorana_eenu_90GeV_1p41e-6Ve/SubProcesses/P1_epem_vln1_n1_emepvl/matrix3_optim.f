...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL IXXXXX(P(0,2),MDL_ME,+1,+1*IC(2),W(1,3))  !  count 11
      CALL IXXXXX(P(0,2),MDL_ME,-1,+1*IC(2),W(1,4))  !  count 14
      CALL IXXXXX(P(0,3),ZERO,+1,-1*IC(3),W(1,5))  !  count 44
      CALL OXXXXX(P(0,4),MDL_ME,+1,+1*IC(4),W(1,6))  !  count 6
      CALL OXXXXX(P(0,4),MDL_ME,-1,+1*IC(4),W(1,7))  !  count 6
      CALL IXXXXX(P(0,5),MDL_ME,+1,-1*IC(5),W(1,8))  !  count 5
      CALL IXXXXX(P(0,5),MDL_ME,-1,-1*IC(5),W(1,9))  !  count 5
      CALL OXXXXX(P(0,6),ZERO,-1,+1*IC(6),W(1,10))  !  count 10
      ...
      CALL FFS4_1(W(1,10),W(1,11),GC_52,MDL_MN1,FK_MDL_WN1,W(1,15))  !  count 6
      CALL FFS4_1(W(1,10),W(1,12),GC_52,MDL_MN1,FK_MDL_WN1,W(1,16))  !  count 6
      CALL FFS4_1(W(1,10),W(1,13),GC_52,MDL_MN1,FK_MDL_WN1,W(1,17))  !  count 6
      CALL FFS4_1(W(1,10),W(1,14),GC_52,MDL_MN1,FK_MDL_WN1,W(1,18))  !  count 3
      CALL FFS1_3(W(1,3),W(1,2),GC_149,MDL_MH,FK_MDL_WH,W(1,19))  !  count 9
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5_1(W(1,10),W(1,21),GC_50,MDL_MN1,FK_MDL_WN1,W(1,25))  !  count 6
      CALL FFV5_1(W(1,10),W(1,22),GC_50,MDL_MN1,FK_MDL_WN1,W(1,26))  !  count 6
      CALL FFV5_1(W(1,10),W(1,23),GC_50,MDL_MN1,FK_MDL_WN1,W(1,27))  !  count 6
      CALL FFV5_1(W(1,10),W(1,24),GC_50,MDL_MN1,FK_MDL_WN1,W(1,28))  !  count 3
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/25,26,27/),
     ...
     & TMP, W, AMP(1,2))  !  count 1
      CALL FFV5_3(W(1,8),W(1,10),GC_22,MDL_MW,FK_MDL_WW,W(1,29))  !  count 2
      CALL FFV5_3(W(1,9),W(1,10),GC_22,MDL_MW,FK_MDL_WW,W(1,30))  !  count 2
      CALL FFV5_1(W(1,6),W(1,29),GC_49,MDL_MN1,FK_MDL_WN1,W(1,31))  !  count 6
      CALL FFV5_1(W(1,6),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,32))  !  count 6
      CALL FFV5_1(W(1,7),W(1,29),GC_49,MDL_MN1,FK_MDL_WN1,W(1,33))  !  count 6
      CALL FFV5_1(W(1,7),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,34))  !  count 3
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(3,
     & (/2,3,1/), 
     & (/31,32,33/),
     ...
     & TMP, W, AMP(1,3))  !  count 1
      CALL FFV5_6_3(W(1,3),W(1,2),GC_44,GC_40,MDL_MZ,FK_MDL_WZ,W(1,35))  !  count 9
      CALL FFV5_6_3(W(1,4),W(1,1),GC_44,GC_40,MDL_MZ,FK_MDL_WZ,W(1,36))  !  count 12
      CALL FFV5P1N_2(W(1,5), W(1,35), GC_50, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/15,16,17/),
     & TMP, W, AMP(1,4))
      CALL FFV5P1N_2(W(1,5), W(1,36), GC_50, TMP(1))
      call CombineAmp(4,
     & (/6,4,7,5/), 
     & (/15,16,17,18/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      CALL FFV5_3(W(1,5),W(1,1),GC_22,MDL_MW,ZERO,W(1,37))  !  count 12
      CALL FFV5_3(W(1,5),W(1,2),GC_22,MDL_MW,ZERO,W(1,38))  !  count 9
      CALL FFV5P1N_2(W(1,3), W(1,38), GC_49, TMP(1))
      call CombineAmp(3,
     & (/2,1,3/), 
     & (/15,16,17/),
     & TMP, W, AMP(1,7))
      CALL FFV5P1N_2(W(1,4), W(1,37), GC_49, TMP(1))
      call CombineAmp(4,
     & (/6,4,7,5/), 
     & (/15,16,17,18/),
