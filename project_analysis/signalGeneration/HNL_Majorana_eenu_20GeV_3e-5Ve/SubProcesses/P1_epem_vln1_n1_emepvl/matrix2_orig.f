...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV5_3(W(1,8),W(1,1),GC_49,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV5_0(W(1,2),W(1,3),W(1,7),GC_22,AMP(7))
      CALL FFV5_3(W(1,10),W(1,1),GC_49,MDL_MW, ZERO,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL FFV5_0(W(1,2),W(1,3),W(1,7),GC_22,AMP(8))
      CALL FFV5_3(W(1,6),W(1,1),GC_49,MDL_MW, ZERO,W(1,7))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +00)*AMP(2)+AMP(3)+(-1.000000000000000D+00)*AMP(4)+(
     $ -1.000000000000000D+00)*AMP(5)+AMP(6)+AMP(7)+AMP(8)+(
