...
C     ----------
     ...
     $    ABS(mdl_mN1*small_width_treatment)), mdl_WN1)
      ...
      CALL FFS4_1(W(1,10),W(1,14),GC_52,MDL_MN1,FK_MDL_WN1,W(1,18))  !  count 6
     ...
     & TMP, W, AMP(1,1))  !  count 1
      ...
      CALL FFV5_1(W(1,10),W(1,24),GC_50,MDL_MN1,FK_MDL_WN1,W(1,28))  !  count 6
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,1,4,2/), 
     & (/25,26,27,28/),
     ...
     & TMP, W, AMP(1,2))  !  count 1
      ...
      CALL FFV5_1(W(1,7),W(1,30),GC_49,MDL_MN1,FK_MDL_WN1,W(1,34))  !  count 6
      CALL FFS3P1N_2(W(1,5), W(1,19), GC_52, TMP(1))
      call CombineAmp(4,
     & (/3,4,1,2/), 
     & (/31,32,33,34/),
     ...
     & TMP, W, AMP(1,6))  !  count 1
      ...
      CALL FFV5_3(W(1,5),W(1,2),GC_22,MDL_MW,ZERO,W(1,38))  !  count 12
