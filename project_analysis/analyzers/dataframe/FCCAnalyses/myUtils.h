...
namespace myUtils{
  ...
  ROOT::VecOps::RVec<float> get_d3d_SV_Error(ROOT::VecOps::RVec<VertexingUtils::FCCAnalysesVertex> vertices, VertexingUtils::FCCAnalysesVertex PV);
  ROOT::VecOps::RVec<float> get_d3d_SV_Sig(ROOT::VecOps::RVec<VertexingUtils::FCCAnalysesVertex> vertices, VertexingUtils::FCCAnalysesVertex PV);
