...
#ana_tex        = ''
delphesVersion = '3.5.3'
#delphesVersion = ''
energy         = 91
collider       = 'FCC-ee'
inputDir       = 'HNL_Signals/output_finalSel_spr21test/'
#inputDir       = 'output_finalSel_Ztautau/'
formats        = ['png','pdf']
formats        = ['pdf']
yaxis          = ['lin','log']
stacksig       = ['nostack']
outdir         = 'HNL_Signals/plots_spr21test'
...
#colors['HNL_Majorana_eenu_10GeV_2e-4Ve'] = ROOT.kAzure-4
#colors['HNL_Majorana_eenu_20GeV_9e-5Ve'] = ROOT.kCyan-9
#colors['HNL_Majorana_eenu_20GeV_3e-5Ve'] = ROOT.kViolet-4
#colors['HNL_Majorana_eenu_30GeV_1e-5Ve'] = ROOT.kRed-3
#colors['HNL_Majorana_eenu_50GeV_6e-6Ve'] = ROOT.kGray+2
