...
inputDir = "recluster_test/spring_backgrounds/output_stage1"
...
outputDir = "recluster_test/spring_backgrounds/output_finalSel_2el"
...
cutList = {
    ...
    "sel2RecoEle_vetoes_rec": "n_RecoElectrons==2 && n_RecoMuons==0 && n_RecoPhotons==0 && n_antikt_jets==0 && n_RecoPhotons==0",
    ...
    "sel2RecoEle_vetoes_MissingEnergyGt10_rec": "n_RecoElectrons==2 && n_RecoMuons==0 && n_RecoPhotons==0 && n_antikt_jets==0 && n_RecoPhotons==0 && RecoMissingEnergy_p[0]>10", #missing energy > 10 GeV
    ...
    "sel2RecoEle_vetoes_MissingEnergyGt10_absD0Gt0p5_rec": "n_RecoElectrons==2 && n_RecoMuons==0 && n_RecoPhotons==0 && n_antikt_jets==0 && n_RecoPhotons==0 && RecoMissingEnergy_p[0]>10 && RecoElectronTrack_absD0[0]>0.5 && RecoElectronTrack_absD0[1]>0.5", #both electrons displaced
...
cutLabels = {
    ...
    "sel2RecoEle_vetoes_rec": "Veto photons, muons, and jets after reclustering",
    "sel2RecoEle_vetoes_MissingEnergyGt10": "$\\not\\! p >$ 10 GeV",
    "sel2RecoEle_vetoes_MissingEnergyGt10_rec": "$\\not\\! p >$ 10 GeV after reclustering",
    "sel2RecoEle_vetoes_MissingEnergyGt10_absD0Gt0p5": "Electron $|d_0| >$ 0.5 mm",
    "sel2RecoEle_vetoes_MissingEnergyGt10_absD0Gt0p5_rec": "Electron $|d_0| >$ 0.5 mm after reclustering",
}
...
histoList = {
    ...
    "n_antikt_jets":             {"name":"n_antikt_jets", "title":"Number of jets after antikt reclustering", "bin":20, "xmin":0, "xmax":10},
