...
inputDir = "recluster_test/missing_energy/output_stage1"
...
outputDir  = "recluster_test/missing_energy/output_finalSel_noscale_binned/"
...
#    "HNL_Majorana_eenu_90GeV_1p41e-6Ve": {"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1.74886e-12, "kfactor": 1.0, "matchingEfficiency": 1.0},
    "HNL_Majorana_eenu_30GeV_1p41e-6Ve": {"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1, "kfactor": 1.0, "matchingEfficiency": 1.0},
    "HNL_Majorana_eenu_50GeV_1p41e-6Ve": {"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1, "kfactor": 1.0, "matchingEfficiency": 1.0},
    "HNL_Majorana_eenu_70GeV_1p41e-6Ve": {"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1, "kfactor": 1.0, "matchingEfficiency": 1.0},
    "HNL_Majorana_eenu_90GeV_1p41e-6Ve": {"numberOfEvents": 50000, "sumOfWeights": 50000, "crossSection": 1, "kfactor": 1.0, "matchingEfficiency": 1.0},
}
...
cutList = {
    ...
    "sel2RecoEle_vetoes_MissingEnergyGt10": "n_RecoElectrons==2 && n_RecoMuons==0 && n_RecoPhotons==0 && n_RecoPhotons==0 && RecoMissingEnergy_p[0]>10",
    ...
    "sel2RecoEle_vetoes_MissingEnergyGt10_absD0Gt0p5": "n_RecoElectrons==2 && n_RecoMuons==0 && n_RecoPhotons==0 && n_RecoPhotons==0 && RecoMissingEnergy_p[0]>10 && RecoElectronTrack_absD0[0]>0.5 && RecoElectronTrack_absD0[1]>0.5", #both electrons displaced
...
cutLabels = {
    ...
    "sel2RecoEle_vetoes": "Veto photons and muons",
...
histoList = {
    ...
    "All_n_GenHNL":                    {"name":"All_n_GenHNL", "title":"Total number of gen HNLs", "bin":64, "xmin":0, "xmax":3.2},
    "AllGenHNL_mass":                  {"name":"AllGenHNL_mass", "title":"Mass of Gen HNL", "bin":100, "xmin":0, "xmax":110},
    "AllGenHNL_p":                     {"name":"AllGenHNL_p", "title":"Magnitude of HNL 3 momentum", "bin":100, "xmin":0, "xmax":50},
    "AllGenHNL_theta":                 {"name":"AllGenHNL_theta", "title":"Theta for generator HNL", "bin":100, "xmin":0, "xmax":3.2},

    "GenHNL_mass":                     {"name":"GenHNL_mass", "title":"Gen N mass", "bin":100, "xmin":0, "xmax":110},
    "GenHNL_p":                        {"name":"GenHNL_p", "title":"Gen N p", "bin":100, "xmin":0, "xmax":50},
    "GenHNL_theta":                    {"name":"GenHNL_theta", "title":"Gen N #theta", "bin":100, "xmin":0, "xmax":3.2},
    "GenHNL_lifetime_xyz":             {"name":"GenHNL_lifetime_xyz", "title": "Gen N #tau", "bin": 100, "xmin": 0, "xmax":10},
...
#    "RecoMuon_charge":   {"name":"RecoMuon_charge",   "title":"Reco muon charge",       "bin":3, "xmin":-1.5,"xmax":1.5},
    ...
    #min delta r between electrons and jets

    "RecoElectron_MinDeltaR":    {"name":"RecoElectron_MinDeltaR", "title":"min #delta r between 2 reco electrons and 1 jet", "bin":100, "xmin":0, "xmax":5},

    #Reclustered jets

    "n_antikt_jets":             {"name":"n_antikt_jets", "title":"n jets after reconstruction with antikt", "bin":5, "xmin":0, "xmax":5, "ymax":300},

    #Missing momentum with new method

    "reclustered_missing_p":     {"name":"reclustered_missing_p", "title": "Total Missing p after reclustering [GeV]", "bin":100, "xmin":0, "xmax":50},
    "new_missing_p":             {"name":"new_missing_p", "title": "Total missing p with new method [GeV]", "bin":200, "xmin":0, "xmax":100},
