...
processList = {
        ...
        #'p8_ee_Zee_ecm91':{'chunks':100, 'fraction':0.25},
        #'p8_ee_Zbb_ecm91':{'chunks':100, 'fraction':0.25},
        #'p8_ee_Ztautau_ecm91':{'chunks':100, 'fraction':0.25},
        #'p8_ee_Zud_ecm91':{'chunks':100, 'fraction':0.25},
        #'p8_ee_Zcc_ecm91':{'chunks':100, 'fraction':0.25},
        #'p8_ee_Zss_ecm91':{'chunks':100, 'fraction':0.25},
        #'p8_ee_Zmumu_ecm91':{'chunks':100, 'fraction':0.25},
...
#outputDir = "reclustered/winterfull/output_stage1"
outputDir = "recluster_test/missing_energy/output_stage1"
...
class RDFanalysis():
		...
		#OVERVIEW: Accessing different objects and counting them
                ...
                .Define("GenHNL_PID", "FCCAnalyses::MCParticle::sel_pdgID(9900012, false)(Particle)")
                .Define("GenHNL_decay", "FCCAnalyses::MCParticle::get_list_of_particles_from_decay(0, GenHNL_PID, Particle1)")

                .Define("All_n_GenHNL", "FCCAnalyses::MCParticle::get_n(GenHNL_PID)")
                .Define("AllGenHNL_mass", "FCCAnalyses::MCParticle::get_mass(GenHNL_PID)") #finding the generator mass of the HNL through separate HNL branch
                .Define("AllGenHNL_e", "FCCAnalyses::MCParticle::get_e(GenHNL_PID)")
                .Define("AllGenHNL_p", "FCCAnalyses::MCParticle::get_p(GenHNL_PID)")
                .Define("AllGenHNL_pt", "FCCAnalyses::MCParticle::get_pt(GenHNL_PID)")    #finding the pt of the HNL thorugh separate HNL branch
                .Define("AllGenHNL_px", "FCCAnalyses::MCParticle::get_px(GenHNL_PID)")
                .Define("AllGenHNL_py", "FCCAnalyses::MCParticle::get_py(GenHNL_PID)")
                .Define("AllGenHNL_pz", "FCCAnalyses::MCParticle::get_pz(GenHNL_PID)")
                .Define("AllGenHNL_eta", "FCCAnalyses::MCParticle::get_eta(GenHNL_PID)")
                .Define("AllGenHNL_theta", "FCCAnalyses::MCParticle::get_theta(GenHNL_PID)")
                .Define("AllGenHNL_phi", "FCCAnalyses::MCParticle::get_phi(GenHNL_PID)")
                .Define("AllGenHNL_charge", "FCCAnalyses::MCParticle::get_charge(GenHNL_PID)")
                .Define("AllGenHNL_genStatus", "FCCAnalyses::MCParticle::get_genStatus(GenHNL_PID)")
                ...
                .Define("GenHNL_indices", "FCCAnalyses::MCParticle::get_indices(9900012, {%s}, true, false, true, true)(Particle, Particle1)"%(daughters))

                # Defining the individual particles from the vector
                .Define("GenHNL", "myUtils::selMC_leg(0)(GenHNL_indices, Particle)")
                .Define("GenHNLElectron", "myUtils::selMC_leg(1)(GenHNL_indices, Particle)")
                ...
                # eenu
                .Define("GenHNLElectron2", "if(GenHNL_indices.size()==4) return myUtils::selMC_leg(2)(GenHNL_indices, Particle); else return GenHNL")
                .Define("GenHNLNeutrino",  "if(GenHNL_indices.size()==4) return myUtils::selMC_leg(3)(GenHNL_indices, Particle); else return GenHNL")
                # ejj
                .Define("GenHNLPiZero",      "if(GenHNL_indices.size()==5) return myUtils::selMC_leg(2)(GenHNL_indices, Particle); else return GenHNL")
                .Define("GenHNLPiPlusMinus", "if(GenHNL_indices.size()==5) return myUtils::selMC_leg(3)(GenHNL_indices, Particle); else return GenHNL")
                .Define("GenHNLPhoton",      "if(GenHNL_indices.size()==5) return myUtils::selMC_leg(4)(GenHNL_indices, Particle); else return GenHNL")
                ...
                .Define("GenHNL_mass", "FCCAnalyses::MCParticle::get_mass( GenHNL )")
                .Define("GenHNL_e", "FCCAnalyses::MCParticle::get_e( GenHNL )")
                .Define("GenHNL_p", "FCCAnalyses::MCParticle::get_p( GenHNL )")
                .Define("GenHNL_pt", "FCCAnalyses::MCParticle::get_pt( GenHNL )")
                .Define("GenHNL_px", "FCCAnalyses::MCParticle::get_px( GenHNL )")
                .Define("GenHNL_py", "FCCAnalyses::MCParticle::get_py( GenHNL )")
                .Define("GenHNL_pz", "FCCAnalyses::MCParticle::get_pz( GenHNL )")
                .Define("GenHNL_eta", "FCCAnalyses::MCParticle::get_eta( GenHNL )")
                .Define("GenHNL_theta", "FCCAnalyses::MCParticle::get_theta( GenHNL )")
                .Define("GenHNL_phi", "FCCAnalyses::MCParticle::get_phi( GenHNL )")
                .Define("GenHNL_charge", "FCCAnalyses::MCParticle::get_charge( GenHNL )")
                .Define("GenHNL_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNL )")

                # Finding the kinematics of each of these daughters
                .Define("GenHNLElectron_mass", "FCCAnalyses::MCParticle::get_mass( GenHNLElectron )")
                .Define("GenHNLElectron_e", "FCCAnalyses::MCParticle::get_e( GenHNLElectron )")
                .Define("GenHNLElectron2_e", "FCCAnalyses::MCParticle::get_e( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_e", "FCCAnalyses::MCParticle::get_e( GenHNLNeutrino )")
                .Define("GenHNLElectron_p", "FCCAnalyses::MCParticle::get_p( GenHNLElectron )")
                .Define("GenHNLElectron2_p", "FCCAnalyses::MCParticle::get_p( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_p", "FCCAnalyses::MCParticle::get_p( GenHNLNeutrino )")
                .Define("GenHNLElectron_pt", "FCCAnalyses::MCParticle::get_pt( GenHNLElectron )")
                .Define("GenHNLElectron2_pt", "FCCAnalyses::MCParticle::get_pt( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_pt", "FCCAnalyses::MCParticle::get_pt( GenHNLNeutrino )")
                .Define("GenHNLElectron_px", "FCCAnalyses::MCParticle::get_px( GenHNLElectron )")
                .Define("GenHNLElectron2_px", "FCCAnalyses::MCParticle::get_px( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_px", "FCCAnalyses::MCParticle::get_px( GenHNLNeutrino )")
                .Define("GenHNLElectron_py", "FCCAnalyses::MCParticle::get_py( GenHNLElectron )")
                .Define("GenHNLElectron2_py", "FCCAnalyses::MCParticle::get_py( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_py", "FCCAnalyses::MCParticle::get_py( GenHNLNeutrino )")
                .Define("GenHNLElectron_pz", "FCCAnalyses::MCParticle::get_pz( GenHNLElectron )")
                .Define("GenHNLElectron2_pz", "FCCAnalyses::MCParticle::get_pz( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_pz", "FCCAnalyses::MCParticle::get_pz( GenHNLNeutrino )")
                .Define("GenHNLElectron_eta", "FCCAnalyses::MCParticle::get_eta( GenHNLElectron )")
                .Define("GenHNLElectron2_eta", "FCCAnalyses::MCParticle::get_eta( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_eta", "FCCAnalyses::MCParticle::get_eta( GenHNLNeutrino )")
                .Define("GenHNLElectron_theta", "FCCAnalyses::MCParticle::get_theta( GenHNLElectron )")
                .Define("GenHNLElectron2_theta", "FCCAnalyses::MCParticle::get_theta( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_theta", "FCCAnalyses::MCParticle::get_theta( GenHNLNeutrino )")
                .Define("GenHNLElectron_phi", "FCCAnalyses::MCParticle::get_phi( GenHNLElectron )")
                .Define("GenHNLElectron2_phi", "FCCAnalyses::MCParticle::get_phi( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_phi", "FCCAnalyses::MCParticle::get_phi( GenHNLNeutrino )")
                .Define("GenHNLElectron_charge", "FCCAnalyses::MCParticle::get_charge( GenHNLElectron )")
                .Define("GenHNLElectron2_charge", "FCCAnalyses::MCParticle::get_charge( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_charge", "FCCAnalyses::MCParticle::get_charge( GenHNLNeutrino )")
                .Define("GenHNLElectron_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNLElectron )")
                .Define("GenHNLElectron2_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNLElectron2 )")
                .Define("GenHNLNeutrino_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNLNeutrino )")

                .Define("GenHNLPiZero_e", "FCCAnalyses::MCParticle::get_e( GenHNLPiZero )")
                .Define("GenHNLPiZero_p", "FCCAnalyses::MCParticle::get_p( GenHNLPiZero )")
                .Define("GenHNLPiZero_pt", "FCCAnalyses::MCParticle::get_pt( GenHNLPiZero )")
                .Define("GenHNLPiZero_px", "FCCAnalyses::MCParticle::get_px( GenHNLPiZero )")
                .Define("GenHNLPiZero_py", "FCCAnalyses::MCParticle::get_py( GenHNLPiZero )")
                .Define("GenHNLPiZero_pz", "FCCAnalyses::MCParticle::get_pz( GenHNLPiZero )")
                .Define("GenHNLPiZero_eta", "FCCAnalyses::MCParticle::get_eta( GenHNLPiZero )")
                .Define("GenHNLPiZero_theta", "FCCAnalyses::MCParticle::get_theta( GenHNLPiZero )")
                .Define("GenHNLPiZero_phi", "FCCAnalyses::MCParticle::get_phi( GenHNLPiZero )")
                .Define("GenHNLPiZero_charge", "FCCAnalyses::MCParticle::get_charge( GenHNLPiZero )")
                .Define("GenHNLPiZero_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNLPiZero )")

                .Define("GenHNLPiPlusMinus_e", "FCCAnalyses::MCParticle::get_e( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_p", "FCCAnalyses::MCParticle::get_p( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_pt", "FCCAnalyses::MCParticle::get_pt( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_px", "FCCAnalyses::MCParticle::get_px( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_py", "FCCAnalyses::MCParticle::get_py( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_pz", "FCCAnalyses::MCParticle::get_pz( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_eta", "FCCAnalyses::MCParticle::get_eta( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_theta", "FCCAnalyses::MCParticle::get_theta( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_phi", "FCCAnalyses::MCParticle::get_phi( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_charge", "FCCAnalyses::MCParticle::get_charge( GenHNLPiPlusMinus )")
                .Define("GenHNLPiPlusMinus_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNLPiPlusMinus )")

                .Define("GenHNLPhoton_e", "FCCAnalyses::MCParticle::get_e( GenHNLPhoton )")
                .Define("GenHNLPhoton_p", "FCCAnalyses::MCParticle::get_p( GenHNLPhoton )")
                .Define("GenHNLPhoton_pt", "FCCAnalyses::MCParticle::get_pt( GenHNLPhoton )")
                .Define("GenHNLPhoton_px", "FCCAnalyses::MCParticle::get_px( GenHNLPhoton )")
                .Define("GenHNLPhoton_py", "FCCAnalyses::MCParticle::get_py( GenHNLPhoton )")
                .Define("GenHNLPhoton_pz", "FCCAnalyses::MCParticle::get_pz( GenHNLPhoton )")
                .Define("GenHNLPhoton_eta", "FCCAnalyses::MCParticle::get_eta( GenHNLPhoton )")
                .Define("GenHNLPhoton_theta", "FCCAnalyses::MCParticle::get_theta( GenHNLPhoton )")
                .Define("GenHNLPhoton_phi", "FCCAnalyses::MCParticle::get_phi( GenHNLPhoton )")
                .Define("GenHNLPhoton_charge", "FCCAnalyses::MCParticle::get_charge( GenHNLPhoton )")
                .Define("GenHNLPhoton_genStatus", "FCCAnalyses::MCParticle::get_genStatus( GenHNLPhoton )")


                # Finding the production vertex of the daughters (checking GenHNLElectron here)
                .Define("GenHNLElectron_vertex_x", "FCCAnalyses::MCParticle::get_vertex_x( GenHNLElectron )")
                .Define("GenHNLElectron_vertex_y", "FCCAnalyses::MCParticle::get_vertex_y( GenHNLElectron )")
                .Define("GenHNLElectron_vertex_z", "FCCAnalyses::MCParticle::get_vertex_z( GenHNLElectron )")
                ...
                .Define("GenHNL_vertex_x", "FCCAnalyses::MCParticle::get_vertex_x(GenHNL_PID)")
                .Define("GenHNL_vertex_y", "FCCAnalyses::MCParticle::get_vertex_y(GenHNL_PID)")
                .Define("GenHNL_vertex_z", "FCCAnalyses::MCParticle::get_vertex_z(GenHNL_PID)")
                ...
                #.Define("GenHNLMCDecayVertex",   "myUtils::BsMCDecayVertex( GenHNL_indices, Particle )")
                ...
                .Define("RecoHNLElectron",   "myUtils::selRP_leg(0)( RecoHNLParticles )")
                .Define("RecoHNLElectron2",   "myUtils::selRP_leg(1)( RecoHNLParticles )")
		...
		#EVENTWIDE VARIABLES: Access quantities that exist only once per event, such as the missing energy (despite the name, the MissingET collection contains the total missing energy)
                ...
                #Finding delta r between electrons and jet for 2 el, 1 jet events.
                .Define("RecoElectron1_deltaeta", "if (n_RecoJets==1 && n_RecoElectrons==2) return (RecoElectron_eta[0] - RecoJet_eta[0]); else return float(-1.);")
                .Define("RecoElectron2_deltaeta", "if (n_RecoJets==1 && n_RecoElectrons==2) return (RecoElectron_eta[1] - RecoJet_eta[0]); else return float(-1.);")
                .Define("RecoElectron1_deltaphi", "if (n_RecoJets==1 && n_RecoElectrons==2) return (RecoElectron_phi[0] - RecoJet_phi[0]); else return float(-1.);")
                .Define("RecoElectron2_deltaphi", "if (n_RecoJets==1 && n_RecoElectrons==2) return (RecoElectron_phi[1] - RecoJet_phi[0]); else return float(-1.);")
                .Define("RecoElectron1_deltar", "if (n_RecoJets==1 && n_RecoElectrons==2) return sqrt(RecoElectron1_deltaeta*RecoElectron1_deltaeta + RecoElectron1_deltaphi*RecoElectron1_deltaphi); else return float(-1.);")
                .Define("RecoElectron2_deltar", "if (n_RecoJets==1 && n_RecoElectrons==2) return sqrt(RecoElectron2_deltaeta*RecoElectron2_deltaeta + RecoElectron2_deltaphi*RecoElectron2_deltaphi); else return float(-1.);")

                .Define("RecoElectron_MinDeltaR", "return min(RecoElectron1_deltar, RecoElectron2_deltar)")
                
                #Trying my new method to find missing momentum
                .Define("new_total_p", "ReconstructedParticle::get_total_p(ReconstructedParticles)")
                .Define("new_missing_p", "sqrt((new_total_p[0])*(new_total_p[0]) + (new_total_p[1])*(new_total_p[1]) + (new_total_p[2])*(new_total_p[2]))")


                # Jet reclustering and finding new deltar
                .Define("my_recoleptons", "ReconstructedParticle::merge(RecoElectrons, RecoMuons)")
                .Define("my_recoparticles", "ReconstructedParticle::remove(ReconstructedParticles, my_recoleptons)")
                ...
                ## Get kinematics of reclustered jets

                .Define("antikt_jet_eta", "JetClusteringUtils::get_eta(antikt_jets)")
                .Define("antikt_jet_phi", "JetClusteringUtils::get_phi(antikt_jets)")
                .Define("n_antikt_jets", "antikt_jet_eta.size()")

                ## Merge reclustered jets and leptons to find new missing energy

                .Define("lepton_p", "ReconstructedParticle::get_total_p(my_recoleptons)")
        ...
        def output():
                branchList = [
                        ...
                        #min delta r for 2 electrons 1 jet

                        "RecoElectron_MinDeltaR",

                        #Reclustered jet data
